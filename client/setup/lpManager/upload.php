...
//Remove the old file
$fileName = "HSLBanner";
$extensions = array("jpg","png","jpeg","tiff");
...
rename($file_path, $fileName.".".$file_ext);


//An Upload has happened. Write the headerConfig file. 

session_start();
$bannerPathFull = "../".$_SESSION['dir']."/manageLP/".$fileName.".".$file_ext;
$mainFile = fopen("../headerConfig.php", "w");
$data  = "<?php $"."topBannerCustom = '".$bannerPathFull."';?>";
